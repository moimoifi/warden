package me.codex.warden.commands;

import me.codex.warden.Main;
import me.codex.warden.utils.TimeUnit;
...
public class Commands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(label.equalsIgnoreCase("warden")) {
            if(!sender.hasPermission("warden")) {
                return true;
            }

            if(args.length < 1 || args.length > 1) {
                sender.sendMessage("§c/warden help");
                return true;
            }
            ...
            if(args[0].equalsIgnoreCase("help")) {
                ...
                sender.sendMessage("§e/warden reload§7: Reload the config and save cache");
                sender.sendMessage("§6--------------------");
